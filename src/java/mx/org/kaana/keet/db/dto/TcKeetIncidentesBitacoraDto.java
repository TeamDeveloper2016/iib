...
@Entity
@Table(name="tc_keet_incidentes_bitacora")
public class TcKeetIncidentesBitacoraDto implements IBaseDto, Serializable {
  ...
  public TcKeetIncidentesBitacoraDto() {
    this(new Long(-1L));
  }

  public TcKeetIncidentesBitacoraDto(Long key) {
    this(null, null, new Long(-1L), null, null);
    setKey(key);
  }

  public TcKeetIncidentesBitacoraDto(String justificacion, Long idIncidente, Long idIncidenteBitacora, Long idUsuario, Long idIncidenteEstatus) {
  ...
  public Class toHbmClass() {
    return TcKeetIncidentesBitacoraDto.class;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final TcKeetIncidentesBitacoraDto other = (TcKeetIncidentesBitacoraDto) obj;
