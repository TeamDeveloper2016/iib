...
public class Notificar implements Serializable {
  ...
  private StringBuilder contenido() throws Exception {
    ...
    regresar.append("Administrador IMOX");
    regresar.append("</td></tr>");
    regresar.append("<tr><td>");
	...
	public static void main(String ... args) throws Exception {
		Notificar notificar= new Notificar("imox.soluciones.web@gmail.com", "jimenez76@yahoo.com", "demostracion", Configuracion.getInstance().getPropiedadServidor("sistema.dns"));
		notificar.enviar();
	}
