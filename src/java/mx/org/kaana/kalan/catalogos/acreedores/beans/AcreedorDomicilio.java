...
public class AcreedorDomicilio extends TrManticAcreedorDomicilioDto {
	
	private static final long serialVersionUID = -5889112018478273306L;
	...
	public AcreedorDomicilio() {
		this(-1L);
	}

	public AcreedorDomicilio(Long key) {
		this(key, ESql.UPDATE);
	}
	
	public AcreedorDomicilio(Long key, ESql sqlAccion) {
		this(key, sqlAccion, false);
	}
	
	public AcreedorDomicilio(Long key, ESql sqlAccion, Boolean nuevo) {		
		this(key, sqlAccion, nuevo, 0L, false, null, null, null, null, null, null, null, null, null, null, null, false);
	}
	
	public AcreedorDomicilio(Long key, ESql sqlAccion, Boolean nuevo, Long consecutivo, Boolean modificar, Entity idEntidad, Entity idMunicipio, Entity idLocalidad, Entity domicilio, String codigoPostal, String calle, String exterior, String interior, String colonia, String entreCalle, String yCalle, boolean nuevoCp) {		
		super(key);
