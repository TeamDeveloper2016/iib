...
public class AcreedorContactoAgente extends TrManticAcreedorAgenteDto implements Serializable {
	...
	public AcreedorContactoAgente() {
		this(-1L);
	}

	public AcreedorContactoAgente(Long key) {
		this(key, ESql.UPDATE);
	}
	
	public AcreedorContactoAgente(Long key, ESql sqlAccion) {
		this(key, sqlAccion, false);
	}
	
	public AcreedorContactoAgente(Long key, ESql sqlAccion, Boolean nuevo) {
		this(key, sqlAccion, nuevo, false, null, new ArrayList<PersonaTipoContacto>(), null, null, null, false);
	}
	
	public AcreedorContactoAgente(Long key, ESql sqlAccion, Boolean nuevo, Boolean principal, String nombres, List<PersonaTipoContacto> contactos, Long consecutivo, String paterno, String materno, Boolean modificar) {
		super(key);
