...
@Entity
@Table(name="tc_kalan_cuentas_estatus")
public class TcKalanCuentasEstatusDto implements IBaseDto, Serializable {
  ...
  public TcKalanCuentasEstatusDto() {
    this(new Long(-1L));
  }

  public TcKalanCuentasEstatusDto(Long key) {
    this(null, null, new Long(-1L), null, null);
    setKey(key);
  }

  public TcKalanCuentasEstatusDto(String descripcion, Long idJustificacion, Long idCuentaEstatus, String estatusAsociados, String nombre) {
  ...
  @Override
  public Long getKey() {
  	return getIdCuentaEstatus();
  }

  @Override
  public void setKey(Long key) {
  	this.idCuentaEstatus = key;
  }
  ...
  public Object[] toArray() {
    ...
    getDescripcion(), getIdJustificacion(), getIdCuentaEstatus(), getEstatusAsociados(), getNombre(), getRegistro()
    };
    return regresar;
  }
  ...
  public String toAllKeys() {
    StringBuilder regresar= new StringBuilder();
    regresar.append("|");
    regresar.append("idCuentaEstatus~");
    regresar.append(getIdCuentaEstatus());
    regresar.append("|");
    return regresar.toString();
  }
  ...
  public Class toHbmClass() {
    return TcKalanCuentasEstatusDto.class;
  }

  @Override
  public boolean isValid() {
  	return getIdCuentaEstatus()!= null && getIdCuentaEstatus()!=-1L;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final TcKalanCuentasEstatusDto other = (TcKalanCuentasEstatusDto) obj;
    if (getIdCuentaEstatus() != other.idCuentaEstatus && (getIdCuentaEstatus() == null || !getIdCuentaEstatus().equals(other.idCuentaEstatus))) {
      return false;
    }
    return true;
  }
  ...
  public int hashCode() {
    int hash = 7;
    hash = 67 * hash + (getIdCuentaEstatus() != null ? getIdCuentaEstatus().hashCode() : 0);
    return hash;
  }
