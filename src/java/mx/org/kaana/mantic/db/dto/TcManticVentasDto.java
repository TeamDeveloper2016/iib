...
public class TcManticVentasDto implements IBaseDto, Cloneable, Serializable {
  ...
  private Long idRegimenFiscal;
	@Column (name="id_acepta")
  private Long idAcepta;
  ...
  public Long getIdAcepta() {
    return idAcepta;
  }

  public void setIdAcepta(Long idAcepta) {
    this.idAcepta = idAcepta;
  }
  ...
  public String toString() {
    ...
    regresar.append("[");
		...
		regresar.append(Constantes.SEPARADOR);
		regresar.append(getIdAcepta());
		regresar.append(Constantes.SEPARADOR);
		regresar.append(getTransporta());
		regresar.append(Constantes.SEPARADOR);
		regresar.append(getIdEspecial());
    regresar.append("]");
  ...
  public Map toMap() {
    Map regresar = new HashMap();
		...
		regresar.put("idAcepta", getIdAcepta());
		regresar.put("transporta", getTransporta());
		regresar.put("idEspecial", getIdEspecial());
  	return regresar;
  }
