...
public class TcManticClientesDto implements IBaseDto, Serializable {
  ...
  public Object[] toArray() {
    Object[] regresar = new Object[]{
      getClave(), getPlazoDias(), getIdCliente(), getLimiteCredito(), getIdCredito(), getRazonSocial(), getSaldo(), getRfc(), getRegistro(), getIdUsuario(), getIdUsoCfdi(), getObservaciones(), getIdEmpresa(), getIdTipoVenta(), getIdFacturama(), getEspecial(), getIdRegimenFiscal(), getPaterno(), getMaterno(), getIdTipoCliente(), getGrupo()
    };
    return regresar;
  }
