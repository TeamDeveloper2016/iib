...
@Entity
@Table(name="tc_mantic_lotes_estatus")
public class TcManticLotesEstatusDto implements IBaseDto, Serializable {
  ...
  public TcManticLotesEstatusDto() {
    this(new Long(-1L));
  }

  public TcManticLotesEstatusDto(Long key) {
    this(null, new Long(-1L), null, null, null);
    setKey(key);
  }

  public TcManticLotesEstatusDto(String descripcion, Long idLoteEstatus, Long idJustificacion, String estatusAsociados, String nombre) {
  ...
  @Override
  public Long getKey() {
  	return getIdLoteEstatus();
  }

  @Override
  public void setKey(Long key) {
  	this.idLoteEstatus = key;
  }
  ...
  public Object[] toArray() {
    ...
    getDescripcion(), getIdLoteEstatus(), getIdJustificacion(), getEstatusAsociados(), getNombre(), getRegistro()
    };
    return regresar;
  }
  ...
  public Class toHbmClass() {
    return TcManticLotesEstatusDto.class;
  }

  @Override
  public boolean isValid() {
  	return getIdLoteEstatus()!= null && getIdLoteEstatus()!=-1L;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final TcManticLotesEstatusDto other = (TcManticLotesEstatusDto) obj;
    if (getIdLoteEstatus() != other.idLoteEstatus && (getIdLoteEstatus() == null || !getIdLoteEstatus().equals(other.idLoteEstatus))) {
      return false;
    }
    return true;
  }
  ...
  public int hashCode() {
    int hash = 7;
    hash = 67 * hash + (getIdLoteEstatus() != null ? getIdLoteEstatus().hashCode() : 0);
    return hash;
  }
