...
@Named(value = "manticCatalogosLimpiosAccion")
@ViewScoped
public class Accion extends IBaseAttribute implements Serializable {

  private static final long serialVersionUID = 127313488565639367L;
	private TcManticNotasLimpiosDto merma;

	public TcManticNotasLimpiosDto getMerma() {
		return this.merma;
	}

	public void setMerma(TcManticNotasLimpiosDto merma) {
		this.merma = merma;
	}	
  ...
  public void doLoad() {
    ...
    try {
      ...
      switch (eaccion) {
        case AGREGAR:											
          this.merma= new TcManticNotasLimpiosDto(
        ...
        case MODIFICAR:					
        case CONSULTAR:					
          this.merma= (TcManticNotasLimpiosDto)DaoFactory.getInstance().findById(TcManticNotasLimpiosDto.class, (Long)this.attrs.get("idNotaLimpio"));
          break;
      } // switch
    } // try
    catch (Exception e) {
  ...
  public String doCancelar() {   
    JsfBase.setFlashAttribute("idNotaLimpio", this.merma.getIdNotaLimpio());
