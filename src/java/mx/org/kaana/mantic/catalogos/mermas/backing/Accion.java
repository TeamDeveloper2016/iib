...
@Named(value = "manticCatalogosMermasAccion")
@ViewScoped
public class Accion extends IBaseAttribute implements Serializable {
  ...
  private static final long serialVersionUID = 327393488565639367L;
	...
	public TcManticNotasMermasDto getMerma() {
		return this.merma;
	}

	public void setMerma(TcManticNotasMermasDto merma) {
		this.merma = merma;
	}	
  ...
  public void doLoad() {
    ...
    try {
      ...
      switch (eaccion) {
        case AGREGAR:											
          this.merma= new TcManticNotasMermasDto(
        ...
        case MODIFICAR:					
        case CONSULTAR:					
          this.merma= (TcManticNotasMermasDto)DaoFactory.getInstance().findById(TcManticNotasMermasDto.class, (Long)this.attrs.get("idNotaMerma"));
          break;
      } // switch
    } // try
    catch (Exception e) {
  ...
  public String doCancelar() {   
    JsfBase.setFlashAttribute("idNotaMerma", this.merma.getIdNotaMerma());
