  ...
  private void addUserAccount(Session sesion, ClienteContactoRepresentante representante) throws Exception {
      ...
      if(persona!= null) {
        ...
        TrManticEmpresaPersonalDto empleado= new TrManticEmpresaPersonalDto(
          ...
          0.0D, // Double factorInfonavit, 
          0.0D, // Double diarioImss, 
          null, // Long idContratista, 
          null, // String nss, 
          representante.getIdRepresentante(), // Long idPersona, 
          1L, // Long idActivo, 
          null, // String infonavit, 
          new Date(Calendar.getInstance().getTimeInMillis()), // Date contratacion, 
          new Date(Calendar.getInstance().getTimeInMillis()), // Date baja, 
          1L, // Long idDepartamento, 
          JsfBase.getIdUsuario(), // Long idUsuario, 
          ...
          new Date(Calendar.getInstance().getTimeInMillis()), // Date ingreso, 
          0.0D, // Double sueldoSemanal,
          0.0D, // Double sueldoMensual, 
          0.0D, // Double sueldoImss, 
          2L, // Long idNomina, 
          2L, // Long idSeguro, 
