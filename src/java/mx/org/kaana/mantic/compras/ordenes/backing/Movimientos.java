...
public class Movimientos extends IBaseFilter implements Serializable {
  ...
  private ETipoMovimiento tipo;
	...
	public boolean getImporte() {
	  return !ETipoMovimiento.TRANSFERENCIAS.equals(this.tipo) && !ETipoMovimiento.MULTIPLES.equals(this.tipo) && !ETipoMovimiento.GASTOS.equals(this.tipo) && !ETipoMovimiento.LOTES.equals(this.tipo) && !ETipoMovimiento.CREDITOS.equals(this.tipo) && !ETipoMovimiento.PRESTAMOS.equals(this.tipo) && !ETipoMovimiento.AHORROS.equals(this.tipo) && !ETipoMovimiento.CUENTAS.equals(this.tipo);
	}
