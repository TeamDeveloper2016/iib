...
public class Articulo extends ArticuloDetalle implements Comparable<Articulo>, Serializable {
  ...
  private Long idProveedor;	
    ...
    this.idAlmacen   = -1L;
    this.almacen     = "";
    this.idCliente   = Constantes.VENTA_AL_PUBLICO_GENERAL_ID_KEY;
	}
  ...
  public String getImporte$() {
	...
	public TcManticNotasDetallesDto toNotaDetalle() {
		...
		return new TcManticNotasDetallesDto(
			...
			this.calculado,
			this.getOrigen(),
      this.getImporte()/ (this.getCantidad()<= 0? 1D: this.getCantidad()), // Double promedio
      0D, // Double gastos
      this.getPesoEstimado() // Double costales
		);	
	}
