...
public abstract class IBaseVenta extends IBaseCliente implements Serializable {
  ...
  public void setCelular(Correo celular) {
    ...
    return this.attrs.get("retorno") != null ? ((String)this.attrs.get("retorno")).concat(Constantes.REDIRECIONAR): "filtro".concat(Constantes.REDIRECIONAR);
  } // doCancelar
	...
	public void doLoadTicketAbiertos() {	
		...
		try {
			...
			params.put(Constantes.SQL_CONDICION, this.toCondicion().concat(" and (tc_mantic_ventas.id_especial= 2)"));
