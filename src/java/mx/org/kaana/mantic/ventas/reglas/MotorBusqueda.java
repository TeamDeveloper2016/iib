...
public class MotorBusqueda extends MotorBusquedaCatalogos implements Serializable{
	...
	public Entity toPrecioCliente(String precioCliente) throws Exception {
		Entity regresar          = null;
		Map<String, Object>params= new HashMap<>();
		try {
			params.put("idArticulo", this.idComodin);
			params.put("idCliente", this.idCliente);
			params.put("precioCliente", precioCliente);
			regresar= (Entity) DaoFactory.getInstance().toEntity("VistaPrecioClienteDto", "cliente", params);
		} // try
		catch (Exception e) {			
			throw e;
		} // catch		
