			...
			for (String item: emails) {
				try {
					if(!Cadena.isVacio(item)) {
					  IBaseAttachment notificar= new IBaseAttachment(ECorreos.FACTURACION, ECorreos.FACTURACION.getEmail(), item, "imox.soluciones.web@gmail.com", Configuracion.getInstance().getEmpresa("titulo").concat(" | Factura"), params, files, ECorreos.FACTURACION.getAlias());
