...
public final class Bonanza implements Serializable {
  ...
  private static final String BODY_CAJA_CHICA  = "\"phone\":\"+521{celular}\",\"message\":\"Estimad@ _{nombre}_,\\n\\n{saludo}, te hacemos llegar el reporte de caja chica de los *residentes* de la semana *{nomina}* del {periodo}, hacer clic en el siguiente enlace  {host}/Temporal/Pdf/{reporte}\\nSe tienen *24 hrs* para descargar el reporte de gastos de caja chica.\\n\\n*_{empresa}_*\"";
  ...
  private static final String PATH_REPORT      = "{numero}.- {documento}; {host}/Temporal/Pdf/{reporte}\\n";
